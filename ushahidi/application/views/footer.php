		...
		<div id="footer">
			<div class="footer-info">
				<ul>
					...
					<li><a href="mailto:contact@freefairelections.com"><?php echo Kohana::lang('ui_main.contact'); ?></a></li>
					<li><a href="http://freefairelections.blogspot.com"><?php echo Kohana::lang('ui_main.blog'); ?></a></li>
